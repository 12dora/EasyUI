  ...
  return {
    ...
    access: {
      ...
      directory: {
        ...
        trustNotAuthoritative: "本次花名册不完整或不够新鲜，所以不会停用任何人；下面的数字只说明读到了什么，不代表已经写入。",
