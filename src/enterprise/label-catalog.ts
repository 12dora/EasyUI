...
function generalSettingsChinese(retry: string): EnterpriseGeneralSettingsLabels {
  return { title: "通用", description: "应用名称、副标题、Logo 与页脚。", loading: "正在加载通用设置", loadFailed: "通用设置加载失败", retry, localeTabs: { "zh-CN": "中文", en: "English" }, appTitle: "应用名称", appTitleHint: "留空使用默认名称。", subtitle: "副标题", subtitleHint: "留空使用默认副标题。", footerHtml: "页脚", footerHtmlHint: "支持少量文本标签与链接；{year} 会替换为当前年份。", logo: "Logo", logoHint: "PNG、JPEG 或 WebP，不超过 128 KB。", logoUpload: "上传 Logo", logoRemove: "移除", logoInvalid: "仅支持 PNG、JPEG 或 WebP 图片。", logoTooLarge: "图片超过 128 KB，请更换更小的文件。", save: "保存", saving: "正在保存", saved: "通用设置已保存", saveFailed: "通用设置保存失败" };
}

function generalSettingsEnglish(retry: string): EnterpriseGeneralSettingsLabels {
  return { title: "General", description: "Application name, subtitle, logo and footer.", loading: "Loading general settings", loadFailed: "Failed to load general settings", retry, localeTabs: { "zh-CN": "中文", en: "English" }, appTitle: "Application name", appTitleHint: "Leave blank to use the default name.", subtitle: "Subtitle", subtitleHint: "Leave blank to use the default subtitle.", footerHtml: "Footer", footerHtmlHint: "A few text tags and links are allowed; {year} is replaced with the current year.", logo: "Logo", logoHint: "PNG, JPEG or WebP, up to 128 KB.", logoUpload: "Upload logo", logoRemove: "Remove", logoInvalid: "Only PNG, JPEG or WebP images are supported.", logoTooLarge: "The image is larger than 128 KB. Choose a smaller file.", save: "Save", saving: "Saving", saved: "General settings saved", saveFailed: "Failed to save general settings" };
}
